 ...
 */
class Sentimood {
  // Modified for negation handling.
  // - not added to AFINN. checks the next sentimental word.
   ...
   */
  negativity(phrase) {
    let addPush; let hits; let i; let item;
    let j; let len; let noPunctuation; let tokens;
    ...
    noPunctuation = phrase.replace(/[^"a-zA-Z ]+/g, ' ')
        .replace('/ {2,}/', ' ');
   ...
   */
  positivity(phrase) {
    let addPush; let hits; let i; let item; let j; let len;
    let noPunctuation; let tokens; let words;
    let notscore = 0;
    let nextitem;
    addPush = function(t, score) {
      hits += score;
  ...
  topicAnalyser(phrase) {
    let addPush; let hits; let i; let item;
    let j; let len; let noPunctuation; let tokens; let words;
    let notscore = 0;
    let nextitem;
    let topic;
    addPush = function(t, score) {
