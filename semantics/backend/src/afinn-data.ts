...
export class Sentimood {
  ...
  topicAnalyser(phrase:string) {
    let addPush:any; let hits:number; let i:any; let item:any; let j:any; let len:number; let noPunctuation:string; let tokens:any; let words: string[];
  ...
  analyze_sentence(phrase: string) {
    let context;
